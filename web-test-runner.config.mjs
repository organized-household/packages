...
export default {
  ...
  groups: [
    {
      name: 'elements',
      files: ['elements/dist/**/*.test.js'],
      testRunnerHtml: (testFramework) => `
        <html lang="en-US">
          <body>
            <script src="elements/dist/main.js" type="module"></script>
            <style> :root { --cs-transition-duration: 0s; } </style>
    ...
    // {
    //   name: 'frontend',
    //   files: ['frontend/dist/**/*.test.js'],
    //   testRunnerHtml: (testFramework) => `
    //     <html lang="en-US">
    //       <body>
    //         <script src="frontend/dist/main.js" type="module"></script>
